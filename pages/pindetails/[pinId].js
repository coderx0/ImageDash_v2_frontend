...
import { cdnClient,urlFor } from '../../lib/sanityClient';
import { sharePinDetailQuery } from '../../lib/Data';
...
const PinDetailsModal = (props) => {
  ...
  return (
      <div
        id="pinModal"
      className="bg-base-100 overflow-x-hidden md:mx-8 xl:mx-24">
...
export async function getServerSideProps(context) {
  ...
  const query = sharePinDetailQuery(pinId);

  const pinData = await cdnClient.fetch(query);
